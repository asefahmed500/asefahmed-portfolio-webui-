...
export default function WorkCRMSignUp() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Join Work CRM</h1>
          <p className="text-foreground-secondary">Create an account to transform your customer relationships</p>
        </motion.div>
        ...
        >
          ...
          <div className="text-center">
            <p className="text-sm">
              ...
              <Link href="/work-crm/signin" className="font-medium text-primary hover:text-primary/80">
                Sign in
              </Link>
            </p>
          </div>
