...
export default function WorkFlowSignIn() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to Work Flow</h1>
          <p className="text-foreground-secondary">Sign in to automate your business processes</p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm">
                <Link href="/work-flow/forgot-password" className="font-medium text-primary hover:text-primary/80">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm">
              ...
              <Link href="/work-flow/signup" className="font-medium text-primary hover:text-primary/80">
                Sign up
              </Link>
            </p>
          </div>
