...
export default function WorkAISignUp() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Join Work AI</h1>
          <p className="text-foreground-secondary">Create an account to start harnessing intelligent automation</p>
        </motion.div>
        ...
        >
          ...
          <div className="text-center">
            <p className="text-sm">
              ...
              <Link href="/work-ai/signin" className="font-medium text-primary hover:text-primary/80">
                Sign in
              </Link>
            </p>
          </div>
