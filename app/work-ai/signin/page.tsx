...
export default function WorkAISignIn() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to Work AI</h1>
          <p className="text-foreground-secondary">Sign in to your account to access intelligent automation</p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm">
                <Link href="/work-ai/forgot-password" className="font-medium text-primary hover:text-primary/80">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-4 px-4 bg-gradient-to-r from-primary to-purple-600 text-white font-medium rounded-xl hover:from-primary/90 hover:to-purple-600/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all"
            >
              Sign in
          ...
          <div className="mt-6 text-center">
            <p className="text-sm">
              ...
              <Link href="/work-ai/signup" className="font-medium text-primary hover:text-primary/80">
                Sign up
              </Link>
            </p>
          </div>
